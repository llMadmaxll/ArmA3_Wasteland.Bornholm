...
[
	...
	["Military Office HQ", "Land_MilOffices_V1_F", 15000, "object"],
	["Military Radar Small", "Land_Radar_Small_F", 10000, "object"],
	["Pillar Pier", "Land_nav_pier_m_F", 10000, "object"],
	["Pier Big Concrete", "Land_Pier_F", 10000, "object"],
	["Canal Wall 10m", "Land_Canal_Wall_10m_F", 8000, "object"],
	["Fence Wired Long 10m", "Land_New_WiredFence_10m_F", 500, "object"],
	["Portable ATM", "Land_Atm_01_F", 20000, "object"],
	...
	["Stadium Lights", "Land_LampHalogen_F", 300, "object"],
	["Shelve", "Land_Metal_wooden_rack_F", 250, "object"],
	["Shed Big", "Land_Shed_Big_F", 250, "object"],
	["Closed Shed", "Land_i_Shed_Ind_F", 400, "object"],
    ["Small Shed", "Land_Shed_Small_F", 300, "object"],
	["Radio Tower", "Land_TTowerBig_2_F", 5000, "object"],
    ["Hanger (Cloth)", "Land_TentHangar_V1_F", 6500, "object"],
	["Hanger Big", "Land_Hangar_F", 10000, "Object"],
    ["Plaster House (2 Story)", "Land_i_House_Big_01_V1_F", 1400, "object"],
    ["Stone House (1 Story)", "Land_i_Stone_HouseSmall_V1_F", 400, "object"],
    ["Bunker", "Land_Bunker_F", 400, "object"],
    ["Stone House (2 Story)", "Land_i_Stone_HouseBig_V1_F", 1400, "object"],
    ["Dome Big", "Land_Dome_Big_F", 11500, "object"],
    ["Dome Small", "Land_Dome_Small_F", 9500, "object"],
    ["Fence Long", "Land_PipeWall_concretel_8m_F", 400, "object"],
	["Garage", "Land_i_Garage_V1_F", 1500, "object"],
	["Crane Big", "Land_Crane_F", 5000, "object"],
	["Reservoir Tower", "Land_ReservoirTower_F", 10000, "object"],	
	["Light House", "Land_LightHouse_F", 8000, "object"],
	["office building Not Complete", "Land_WIP_F", 5000, "object"],
	["Office Building", "Land_Offices_01_V1_F", 10000, "object"],
	["Street Lamp Big", "Land_LampStreet_F", 250, "object"],
	["Street Lamp small", "Land_LampStreet_small_F", 200, "object"],
	["Nav Light Single", "Land_NavigLight", 300, "object"],
	["Nav Light Tripple", "Land_NavigLight_3_F", 400, "object"],
	["Office Building (2 Story)", "Land_i_Barracks_V1_F", 23000, "object"]
];
...
[
	...
	["Sikorsky HH-60 Pave Hawk", "USAF_HH60G", 45000, "Vehicle"],
...
[
	...
	["A-143 Buzzard CAS", "I_Plane_Fighter_03_CAS_F", 500000, "vehicle"],
	["To-199 Neophron CAS", "O_Plane_CAS_02_F", 900000, "vehicle"],
	["A-164 Wipeout CAS", "B_Plane_CAS_01_F", 1000000, "vehicle"],
	["MQ4A Greyhawk ATGM UAV", "B_UAV_02_F", 500000, "vehicle"],
	["MQ4A Greyhawk Bomber UAV", "B_UAV_02_CAS_F", 400000, "vehicle"], // Bomber UAVs are a lot harder to use, hence why they are cheaper than ATGMs
	["K40 Ababil-3 ATGM UAV (CSAT)", "O_UAV_02_F", 500000, "vehicle"],
	["K40 Ababil-3 Bomber UAV (CSAT)", "O_UAV_02_CAS_F", 400000, "vehicle"],
	["K40 Ababil-3 ATGM UAV (AAF)", "I_UAV_02_F", 500000, "vehicle"],
	["K40 Ababil-3 Bomber UAV (AAF)", "I_UAV_02_CAS_F", 400000, "vehicle"],
	["C17 Globemaster", "globemaster_c17_nato", 250000, "Vehicle"],
	["F16 Fighter", "USAF_F16", 100000, "Vehicle"],
	["B2 Spirit", "USAF_b2", 5000000, "Vehicle"],
	["B1 Bomber", "USAF_B1B", 5000000, "Vehicle"],
	["Lockheed Martin F-22 Raptor", "USAF_F22", 100000, "Vehicle"],
	["A-10 ThunderBolt", "USAF_A10", 150000, "Vehicle"],
	["CV-22 Osprey", "USAF_CV22", 55000, "Vehicle"],
	["AC 130 Gunship", "USAF_AC130U", 1000000, "Vehicle"]
];
