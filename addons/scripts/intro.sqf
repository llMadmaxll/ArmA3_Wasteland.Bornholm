...
_messages = [
	["ALG", "Armor Legion Gaming A3Wasteland"],
	["Welcome", (name player)],
	["A3Wasteland", worldName],
	["Teamspeak", "41.72.129.92:9986"],
	["Website/Forums", "www.armorlegiongaming.co.za"],
	["Saving", "Check the Server Rules to see saving times."],
	["ATM / Bank", "You can use any ATM found in Bornholm."],
