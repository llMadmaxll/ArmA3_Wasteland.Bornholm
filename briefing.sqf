...
"v1.2",
"
<br/>[Added] USAF Vehicles
<br/>[Added] Russian Spetznaz Vehicles
<br/>[Added] C17 Globemaster Gargo Plane
<br/>[Added] Few new items to the General store
<br/>[Changed] Moved mission locations
<br/>[Changed] More Ai and Tanks to missions
<br/>[Changed] Blackfoot added to Heavy Money Shipment
