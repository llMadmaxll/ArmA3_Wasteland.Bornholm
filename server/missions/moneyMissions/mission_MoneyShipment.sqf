		...
		[
			...
			[
				[ // NATO convoy
					...
					["B_MRAP_01_hmg_F", "B_MRAP_01_gmg_F"], // Veh 4
					["B_MRAP_01_hmg_F", "B_MRAP_01_gmg_F"] // Veh 5
				],
				[ // CSAT convoy
					["O_MRAP_02_hmg_F", "O_MRAP_02_gmg_F"], // Veh 1
					["O_MRAP_02_hmg_F", "O_MRAP_02_gmg_F"], // Veh 2
					["O_MRAP_02_hmg_F", "O_MRAP_02_gmg_F"], // Veh 3
					["O_MRAP_02_hmg_F", "O_MRAP_02_gmg_F"], // Veh 4
					["O_MRAP_02_hmg_F", "O_MRAP_02_gmg_F"] // Veh 5
				],
				[ // AAF convoy
					["I_MRAP_03_hmg_F", "I_MRAP_03_gmg_F"], // Veh 1
					["I_MRAP_03_hmg_F", "I_MRAP_03_gmg_F"], // Veh 2
					["I_MRAP_03_hmg_F", "I_MRAP_03_gmg_F"], // Veh 3
					["I_MRAP_03_hmg_F", "I_MRAP_03_gmg_F"], // Veh 4
					["I_MRAP_03_hmg_F", "I_MRAP_03_gmg_F"] // Veh 5
				]
			]
		],
		// Medium
		...
		[
			...
			[
				[ // NATO convoy
					...
					["B_APC_Wheeled_01_cannon_F", "B_APC_Tracked_01_rcws_F", "B_APC_Tracked_01_AA_F"] // Veh 4
				],
				[ // CSAT convoy
					...
					["O_APC_Wheeled_02_rcws_F", "O_APC_Tracked_02_cannon_F", "O_APC_Tracked_02_AA_F"] // Veh 4
				],
				[ // AAF convoy
					["I_APC_Wheeled_03_cannon_F", "I_APC_tracked_03_cannon_F"], // Veh 1
					["I_MBT_03_cannon_F"], // Veh 2
					["I_MBT_03_cannon_F"], // Veh 3
					["I_APC_Wheeled_03_cannon_F", "I_APC_tracked_03_cannon_F"] // Veh 4
				]
			]
		],
		// Extreme
